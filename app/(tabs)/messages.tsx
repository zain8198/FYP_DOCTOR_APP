            ...
            onValue(chatsRef, async (snapshot) => {
                ...
                for (const chatId in allChats) {
                    if (chatId.includes(currentUserId)) {
                        ...
                        const doctorId = participantIds.find(id => id !== currentUserId);
                        ...
                        try {
                            ...
                            if (docSnap.exists()) {
                                ...
                                doctorImage = docData.image || null;
                            }
                        } catch (err) {
        ...
        >
            <View style={styles.avatarContainer}>
                {item.doctorImage ? (
                    ...
                    <Avatar.Text
                        size={55}
                        label={item.doctorName.substring(0, 2).toUpperCase()}
            ...
            {filteredChats.length === 0 ? (
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptySubtext}>
                        {searchQuery ? 'Try a different search term' : 'Start chatting with a doctor from their profile'}
                    </Text>
                </View>
            ) : (
                <FlatList
